const DeadLinkPopup = ({ isModalOpen, setIsModalOpen }) => {
  return (
    <div
      ...
      } absolute top-24 right-1/2 translate-x-1/2 mx-auto p-3 border w-[400px] shadow-lg rounded-md bg-white transition-all duration-500`}
    >
      <div className="mt-3 text-center">
        ...
        <div className="mt-2 px-7 py-3">
          <p>Explore features like search, map, listings etc.</p>
        </div>
